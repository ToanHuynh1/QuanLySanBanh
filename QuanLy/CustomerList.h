...
public:
	...
	bool IsExistCustomer();
	void PrintForm();
};
void CustomerList::fOutputApp(Customer data)
{
	ofstream fileout;
	ifstream filein;
...
inline bool CustomerList::IsExistCustomer()
{

	return false;
}
Customer CustomerList::ReturnById(string id)
{
	Customer customer;
...
void CustomerList::DetroyCustomerList()//true
{
	CustomerNode* temp = this->head;
...
bool CustomerList::IsExitCustomer(string id)
{
...
Customer CustomerList::InputCustomer() //// true
{
	Customer customer;
NHAPLAICMND:
	try
...
void CustomerList::fInputCustomers()
{
	Customer customer;
	ifstream filein;
	//bool k = false;
...
void CustomerList::DeleteById(string id)//xóa 1
{
...
bool CustomerList::IsExistId(string id)
{
	CustomerNode* temp = head;
	while (temp != nullptr)
	{
...
void CustomerList::AddHead(Customer data)//true
{
