...
void Menu(TradeList* tradeList)
{
	...
	cout << right << setw(25) << "" << "|\t1. Khach hang dat san" << right << setw(25) << "|" << "Gia san 5/SANG: " << tradeList->price->perHourN << endl;
	cout << right << setw(25) << "" << "|\t2. Khach hang tra san " << right << setw(27) << "|" << "	Gia san 5/DEM: " << tradeList->price->perNightN << endl;
	cout << right << setw(25) << "" << "|\t3. Tim kiem khach hang" << right << setw(27) << "|" << "	Gia san 11/SANG: " << tradeList->price->perHourM << endl;
	cout << right << setw(25) << "" << "|\t4. Tim kiem khach hang dang muon san" << right << setw(11) << "|" << "	Gia san 11/DEM: " << tradeList->price->perNightM << endl;
	cout << right << setw(25) << "" << "|\t5. Danh sach khach hang" << right << setw(26) << "|" << endl;
	cout << right << setw(25) << "" << "|\t6. Danh sach khach hang dang muon san" << right << setw(10) << "|" << endl;
	cout << right << setw(25) << "" << "|\t7. Danh sach lich su giao dich" << right << setw(19) << "|" << endl;
	cout << right << setw(25) << "" << "|\t8. Danh sach san" << right << setw(31) << "|" << endl;
	cout << right << setw(25) << "" << "|\t9. Danh sach cac san con trong" << right << setw(17) << "|" << endl;
	cout << right << setw(25) << "" << "|\t10. Cap nhat them san" << right << setw(26) << "|" << endl;
	cout << right << setw(25) << "" << "|\t11. Cap nhat lai gia san" << right << setw(23) << "|" << endl;
	cout << right << setw(25) << "" << "|\t12. Cap nhat trang thai san sau khi bao tri" << right << setw(8) << "|" << endl;
	cout << right << setw(25) << "" << "|\t13. So luong san cua san banh" << right << setw(17) << "|" << endl;
	cout << right << setw(25) << "" << "|\t14. Doanh thu trong ngay" << right << setw(25) << "|" << endl;
	cout << right << setw(25) << "" << "|\t15. Danh sach cac dich vu" << right << setw(25) << "|" << endl;
